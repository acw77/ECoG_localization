...
% Last Modified by GUIDE v2.5 12-Dec-2018 13:02:31
...
% cnt=1;
% ndir=dir([dbsroot,'dbs_coregistration.m']);
...
%     error('Please install SPM12 for Lead-DBS to work properly.');
%     end
% end
% try % set selection of ctcoregmethod to default entry (specified in dbs_prefs).
...
% --- Executes on key press with focus on recentpts and none of its controls.
function recentpts_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to recentpts (see GCBO)
